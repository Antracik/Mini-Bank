...
namespace Mini_Bank.Migrations
{
    ...
    [Migration("20190801103741_Test6")]
    partial class Test6
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.AccountDbRepoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.RegistrantDbRepoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.UserDbRepoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.WalletDbRepoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.AccountDbRepoModel", b =>
                {
                    ...
                    b.HasOne("Mini_Bank.DbRepo.Models.WalletDbRepoModel", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.RegistrantDbRepoModel", b =>
                {
                    ...
                    b.HasOne("Mini_Bank.DbRepo.Models.UserDbRepoModel", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Mini_Bank.DbRepo.Models.WalletDbRepoModel", b =>
                {
                    b.HasOne("Mini_Bank.DbRepo.Models.RegistrantDbRepoModel", "Registrant")
                        .WithMany()
